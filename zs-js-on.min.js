...
function zsJsOn(
  A,C,c,S,h,a,b,e,o){o=h[C];if(!o)return h[C]=A;o=S+o+S;e=o.indexOf(A);a=o[c](e
  +A.length);b=o[c](e-1);if(e<0||a!=S||b!=S)h[C]+=S+A}
...
/* Paste the following into the `<HEAD>` section of your HTML:
  ...
  <!-- Add zs-js-on to <html class...> if JS is running --><script>!function(
  A,C,c,S,h,a,b,e,o){o=h[C];if(!o)return h[C]=A;o=S+o+S;e=o.indexOf(A);a=o[c](e
  +A.length);b=o[c](e-1);if(e<0||a!=S||b!=S)h[C]+=S+A}('zs-js-on','className',
  'charAt',' ',document.documentElement)//0bdx.com/zs-js-on#0.0.1</script>
*/